...
object DateUtil {
    ...
    fun getDate(dateMillis: Long, pattern: String = "yyyy-MM-dd") = SimpleDateFormat(pattern, Locale.getDefault()).format(
        Date(dateMillis)
    )

    private fun getDateAndTime(dateMillis: Long) = SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.getDefault()).format(
        Date(dateMillis)
    )

    private fun getDateAndHourMinuteTime(dateMillis: Long) = SimpleDateFormat("HH:mm", Locale.getDefault()).format(
        Date(dateMillis)
    )
