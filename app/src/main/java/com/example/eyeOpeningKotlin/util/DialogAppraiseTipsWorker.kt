...
import com.example.eyeOpeningKotlin.extension.screenWidth
...
class DialogAppraiseTipsWorker(val context: Context,params: WorkerParameters): Worker(context,params) {
    ...
    companion object {
        ...
        fun showDialog(context: Context){
            ...
            val dialogView = LayoutInflater.from(context).inflate(R.layout.dialog_appraise_tips,null)
                .apply{
            ...
            dialog = AlertDialog.Builder(context,R.style.EyeOpeningAlertDialogStyle).setCancelable(false).setView(dialogView).create()
            dialog?.show()
