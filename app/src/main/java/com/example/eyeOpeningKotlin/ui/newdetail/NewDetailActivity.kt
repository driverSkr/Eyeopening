...
import com.example.eyeOpeningKotlin.databinding.ActivityNewDetailBinding
...
class NewDetailActivity : BaseActivity() {
    ...
    private val viewModel by lazy { ViewModelProvider(this, InjectorUtil.getNewDetailViewModelFactory())[NewDetailViewModel::class.java] }
