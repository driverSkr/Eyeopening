...
import com.example.eyeOpeningKotlin.ui.common.callback.RequestLifecycle
...
open class BaseFragment: Fragment(), RequestLifecycle {
    ...
    protected fun showDialogShare(shareContent: String) {
        if (this.activity is AppCompatActivity) {
            com.example.eyeOpeningKotlin.extension.showDialogShare(this.activity as AppCompatActivity, shareContent)
        }
    }
}