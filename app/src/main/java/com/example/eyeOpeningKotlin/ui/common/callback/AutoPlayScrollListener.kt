 ...
 * @since 2023/10/24
 */
class AutoPlayScrollListener(private val viewPager: ViewPager2, private var defaultPosition: Int, private val itemPlayId: Int) : ViewPager2.OnPageChangeCallback() {
