...
import com.example.eye_openingKotlin.ui.common.callback.RequestLifecycle
import com.example.eye_openingKotlin.util.ShareUtil
...
open class BaseFragment : Fragment(), RequestLifecycle {
    ...
    protected fun showDialogShare(shareContent: String) {
        if (this.activity is AppCompatActivity) {
            com.example.eye_openingKotlin.extension.showDialogShare(this.activity as AppCompatActivity, shareContent)
        }
    }
}