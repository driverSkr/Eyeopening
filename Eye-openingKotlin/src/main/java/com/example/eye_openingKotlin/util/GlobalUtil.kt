...
import com.example.eye_openingKotlin.extension.logW
...
object GlobalUtil {
    ...
    val appPackage: String
        get() = EyeopeningApplication.context.packageName
     ...
     */
    val appName: String
        get() = EyeopeningApplication.context.resources.getString(EyeopeningApplication.context.applicationInfo.labelRes)
    ...
    val appVersionName: String
        get() = EyeopeningApplication.context.packageManager.getPackageInfo(appPackage, 0).versionName
    ...
    fun getApplicationMetaData(key: String): String? {
        ...
        try {
            applicationInfo = EyeopeningApplication.context.packageManager.getApplicationInfo(appPackage, PackageManager.GET_META_DATA)
